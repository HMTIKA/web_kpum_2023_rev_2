                ...
                <div class="col-lg-4">
                    <div class="card p-3 mb-4">
                        <form action="">
                            ...
                            <input class="mb-2" type="text" name="" id="" value="<?php echo "NAMA CAPRESMA & NAMA CAWAPRESMA" ?>">
                            <button class="btn btn-md btn-warning w-100 mb-2">Update</button>
                        </form>
                        <button class="btn btn-md btn-danger w-100">Delete</button>
                    </div>
                </div>
                <div class="col-lg-4">
                    <div class="card p-3 mb-4">
